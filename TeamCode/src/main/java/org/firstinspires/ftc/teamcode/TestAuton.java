...
public class TestAuton extends LinearOpMode
{
    ...
    public void runOpMode()
    {
        ...
        {
            moveCmd.MoveToPosition(autonSpeed, 0, 0, 0, 1, 2, 0, 0.45, 3300, false, false);
            moveCmd.MoveToPosition(autonSpeed, 24, 0, 0, 1, 2, 0, 0.45, 3300, false, false);
            moveCmd.MoveToPosition(autonSpeed, 24, 24, 0, 1, 2, 0, 0.45, 3300, false, false);
//            Shoot(0);
//
//            SpikeMarkTwo(0);
//            Shoot(0);

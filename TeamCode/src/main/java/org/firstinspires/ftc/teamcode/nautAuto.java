...
@Autonomous
public class nautAuto extends LinearOpMode//lemme in pls
{
...
//            Shoot(-2);
    ...
    {
        moveCmd.MoveToPosition(autonSpeed, 0 + offset, -25.5 + offset, 0, 2, 2, 10, 0.45, 3200, false, false); // might have to swap intaking to true
        // do we need spin up time?
        timer.reset();
        while (timer.seconds() < 1)
        {
            moveCmd.MoveToPosition(0, -30 + offset, -25.5 + offset, 0, 2, 4, 10, 0.45, 3200, false, false);
        }

        moveCmd.MoveToPosition(autonSpeed, -30 + offset, -25.5 + offset, 0, 2, 4, 10, 0.45, 3200, false, true);
        sleep(500);

        moveCmd.MoveToPosition(autonSpeed, -10 + offset, -20 + offset, 0, 2, 2, 10, 0.45, 3200, false, true);
    }
